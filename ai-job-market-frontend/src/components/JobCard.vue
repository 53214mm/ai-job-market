...
<template>
  <div class="bg-white border border-gray-200 rounded-lg p-5 hover:shadow-md hover:border-blue-200 transition-all cursor-pointer">
    ...
    <div class="mt-3 flex items-center justify-between">
      <span class="text-xs text-gray-400">{{ job.postedTime || '刚刚发布' }}</span>
      <button class="text-xs font-medium text-blue-600 hover:text-blue-700 px-3 py-1.5 bg-blue-50 rounded-md hover:bg-blue-100 transition-colors">
        立即投递
      </button>
    </div>
  </div>
